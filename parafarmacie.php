...
<html>
    <head>
        <title>Parafarmacie</title>
 
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="parafarmacie.css"/>
        ...
        <script src="parafarmacie.js" defer></script>
    ...
    <body>
        ...
        <section>
            ...
            <div id="sub-section-starred" class="hidden">
                <div id="titlesss">Preferiti</div>
                <div id="ssselement"></div>
            </div>

            <div id="sub-section-search" >
                Cerca la Parafarmacia</br>
                <input id="input" type='text' placeholder='Inserisci la tua citt&agrave o il CAP'>
            </div>
