...
<html>
    <head>
        <title>Info su medicinale</title>
 
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="info_med.css"/>
        ...
        <script src="info_med.js" defer></script>
    ...
    <body>
        ...
        <section>
            ...
            <div id="sub-section-search" >
                Cerca il medicinale</br>
                <input id="input" type='text' placeholder='Inserisci il principio attivo'>
            </div>
