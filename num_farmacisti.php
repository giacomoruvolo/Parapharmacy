...
<html>
    <head>
        <title>Numero Farmacisti</title>
 
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="num_farmacisti.css"/>
        ...
        <script src="num_farmacisti.js" defer></script>
    ...
    <body>
        ...
        <section>
            ...
            <div id="sub-section-search" >
                ...
                <input id="input" type='text' placeholder='Inserisci il nome della Parafarmacia'>
            </div>
